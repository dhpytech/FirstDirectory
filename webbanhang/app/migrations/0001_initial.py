# Generated by Django 4.2.4 on 2023-10-13 14:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('userImage', models.ImageField(blank=True, default='', null=True, upload_to='')),
                ('userPhone', models.CharField(blank=True, default='', max_length=12, null=True)),
                ('facebook', models.TextField(blank=True, default='', null=True)),
                ('twitter', models.TextField(blank=True, default='', null=True)),
                ('tiktok', models.TextField(blank=True, default='', null=True)),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
